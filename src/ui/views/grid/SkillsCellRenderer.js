    ...
    render() {
        ...
        RefData.IT_SKILLS.forEach( (skill) => {
            if (rowData.skills[skill]) {
                skills.push(<img onClick={this.test.bind(this, this.props.params, skill)} key={skill} src={'images/skills/' + skill + '.png'} width={16} title={skill} />);
            }
        });
